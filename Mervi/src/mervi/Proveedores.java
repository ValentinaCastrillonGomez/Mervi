...
/**
 *
 * @author Valentina Castrillon Gomez- Laura Cristina Marin Velez Fecha: creada
 * mayo 23/2015 esta es la clase se crea el formulario de proveedores  
 *
 **/
...
public class Proveedores extends JFrame implements ActionListener, KeyListener {
    ...
    /**
     * Declarar los objetos de Jlabel, jtextfield, Jpasswordfield, RadioButton y
     * JComboBox
    **/
    ...
    **/
    ...
    public Proveedores() {
        ...
        **/
        ...
        /**
         * Se crea el tamaño y ubicacion de los JTextField(cuadros de texto) que
         * se declararon
         **/
